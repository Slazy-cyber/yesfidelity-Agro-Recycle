...
import RecycleCards from '../components/RecycleCards';
      ...
      <section className="py-20 px-6 bg-white">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="flex items-center gap-2 text-green-600 font-medium mb-8">
            ...
            <span>/</span>
            <span className="text-green-800">Recycling Materials</span>
          </div>
          ...
          {/* Description */}
          <p className="text-lg md:text-xl text-green-700 max-w-3xl mb-12 leading-relaxed">
            Sustainable solutions for a circular economy. Discover high-quality recycled and recyclable materials for your business needs.
          </p>
...
export default RecyclingMaterials
